...
export function createDroneMesh() {
    ...
    const leftFinAccent = new THREE.Mesh(new THREE.BoxGeometry(0.05, 0.3, 0.02), finAccentMaterial);
    ...
    const rightFinAccent = new THREE.Mesh(new THREE.BoxGeometry(0.05, 0.3, 0.02), finAccentMaterial);
...
export class Enemy {
    ...
    constructor(scene, id, type) {
        ...
        Object.defineProperty(this, "movementPattern", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 'straight'
        ...
        Object.defineProperty(this, "patternAmplitude", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 1.0
        ...
        Object.defineProperty(this, "patternFrequency", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 1.0
        ...
        Object.defineProperty(this, "patternPhase", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "hoverTargetY", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 5
        ...
        Object.defineProperty(this, "hoverReached", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        ...
        Object.defineProperty(this, "warpInProgress", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        ...
        Object.defineProperty(this, "warpInTimer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "warpInDuration", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0.3
        ...
        Object.defineProperty(this, "originalEmissiveIntensities", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        ...
        Object.defineProperty(this, "originalEmissiveColors", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
     ...
     */
    flashHit() {
        // Store original emissive values and set to white
        ...
        // Set flash timer for restoration
        this.flashTimer = 0.1;
    }
    /**
...
export class Sentry extends Enemy {
    ...
    fire(bulletPool, playerPosition) {
        ...
        const barrelData = this.mesh.userData;
 ...
 */
export function createEnemy(scene, id, type) {
    switch (type) {
        case 'drone':
