...
export class LevelFlowManager {
    ...
    constructor(level) {
        ...
        Object.defineProperty(this, "currentWaveIndex", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "bossWarningTriggered", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        ...
        switch (waveType) {
            ...
            case 'elite-combined': {
                if (this.levelNumber === 3) {
                    ...
                    const eliteTypes = ['reaper', 'warden', 'harbinger', 'overlord'];
