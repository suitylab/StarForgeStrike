...
class LaserBarrageShot {
    ...
    constructor(scene) {
        ...
        const body = new THREE.Mesh(new THREE.CylinderGeometry(0.08, 0.12, 0.8, 8), bodyMaterial);
        ...
        this.core = new THREE.Mesh(new THREE.SphereGeometry(0.1, 8, 8), coreMaterial);
        ...
        this.trail = new THREE.Mesh(new THREE.ConeGeometry(0.06, 0.6, 8), trailMaterial);
    ...
    update(delta) {
        ...
        if (this.delay > 0) {
            ...
            this.core.material.opacity = 0.7 + pulse * 0.3;
            return;
        }
        // Move the shot
    ...
    getBounds() {
        ...
        return new THREE.Box3(new THREE.Vector3(pos.x - halfSize, pos.y - halfSize, pos.z - halfSize), new THREE.Vector3(pos.x + halfSize, pos.y + halfSize, pos.z + halfSize));
    }
    /**
...
export class SovereignBoss {
    ...
    constructor(scene, id) {
        ...
        Object.defineProperty(this, "driftTime", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "spirePulseTime", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "accentPulseTime", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "enginePulseTime", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "turretPulseTime", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "bulletWallDirection", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: true
        ...
        Object.defineProperty(this, "phase3RadialAlternator", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        ...
        Object.defineProperty(this, "laserBarrageQueue", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        ...
        Object.defineProperty(this, "commandSpire", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "spireGlow", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "energyCoreGlow", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "turretBanks", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        ...
        Object.defineProperty(this, "accentLights", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        ...
        Object.defineProperty(this, "glowRing", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        if (this.descending) {
            ...
            if (currentY > targetY) {
                ...
                if (this.glowRing) {
                    ...
                    this.glowRing.material.opacity = 0.8 * (1 - progress * 0.5);
                }
            }
            else {
     ...
     * @param playerPosition - The player's current position
     */
    fireLaserBarrage(bulletPool, pos, playerPosition) {
     ...
     * @param pos - The boss's position
     */
    fireRadialBurst(bulletPool, pos) {
     ...
     * @param playerPosition - The player's current position
     */
    updateLaserBarrage(delta, playerPosition) {
        for (const shot of this.laserBarrageQueue) {
            if (shot.active) {
                shot.update(delta);
            }
    ...
    updateAnimations(delta) {
        ...
        if (this.commandSpire) {
            ...
            const material = this.commandSpire.material;
        ...
        if (this.spireGlow) {
            ...
            const material = this.spireGlow.material;
        ...
        if (this.energyCoreGlow) {
            ...
            const material = this.energyCoreGlow.material;
        ...
        for (const turret of this.turretBanks) {
            const material = turret.material;
    ...
    buildMainHull() {
        ...
        // Main hull
        const hull = new THREE.Mesh(new THREE.BoxGeometry(4.5, 2.5, 1.5), hullMaterial);
        this.mesh.add(hull);
        ...
        const bottomPlate = new THREE.Mesh(new THREE.BoxGeometry(4.2, 0.3, 1.3), bottomPlateMaterial);
        ...
        const topPlate = new THREE.Mesh(new THREE.BoxGeometry(4.2, 0.3, 1.3), topPlateMaterial);
    ...
    buildArmorPlates() {
        ...
        const frontPlate = new THREE.Mesh(new THREE.BoxGeometry(4.0, 0.4, 1.2), whitePlateMaterial);
        frontPlate.position.set(0, -1.0, 0);
        this.mesh.add(frontPlate);
        // Gold trim on front plate
        const frontGoldTrim = new THREE.Mesh(new THREE.BoxGeometry(4.0, 0.08, 1.2), goldPlateMaterial);
        frontGoldTrim.position.set(0, -0.8, 0);
        this.mesh.add(frontGoldTrim);
        // Mid armor plate (gold)
        const midPlate = new THREE.Mesh(new THREE.BoxGeometry(3.5, 0.35, 1.1), goldPlateMaterial);
        midPlate.position.set(0, -0.5, 0);
        this.mesh.add(midPlate);
        // White trim on mid plate
        const midWhiteTrim = new THREE.Mesh(new THREE.BoxGeometry(3.5, 0.08, 1.1), whitePlateMaterial);
        midWhiteTrim.position.set(0, -0.3, 0);
        this.mesh.add(midWhiteTrim);
        // Rear armor plate (white)
        const rearPlate = new THREE.Mesh(new THREE.BoxGeometry(3.0, 0.3, 1.0), whitePlateMaterial);
        rearPlate.position.set(0, 0, 0);
        this.mesh.add(rearPlate);
        // Gold trim on rear plate
        const rearGoldTrim = new THREE.Mesh(new THREE.BoxGeometry(3.0, 0.08, 1.0), goldPlateMaterial);
    ...
    buildGoldTrim() {
        ...
        // Top edge trim
        const topTrim = new THREE.Mesh(new THREE.BoxGeometry(4.5, 0.1, 0.1), goldTrimMaterial);
        topTrim.position.set(0, 1.25, 0.7);
        this.mesh.add(topTrim);
        // Bottom edge trim
        const bottomTrim = new THREE.Mesh(new THREE.BoxGeometry(4.5, 0.1, 0.1), goldTrimMaterial);
        bottomTrim.position.set(0, -1.25, 0.7);
        this.mesh.add(bottomTrim);
        // Left edge trim
        const leftTrim = new THREE.Mesh(new THREE.BoxGeometry(0.1, 2.5, 0.1), goldTrimMaterial);
        leftTrim.position.set(-2.25, 0, 0.7);
        this.mesh.add(leftTrim);
        // Right edge trim
        const rightTrim = new THREE.Mesh(new THREE.BoxGeometry(0.1, 2.5, 0.1), goldTrimMaterial);
        rightTrim.position.set(2.25, 0, 0.7);
        this.mesh.add(rightTrim);
        // Vertical trim strips along the hull sides
        for (let i = 0; i < 3; i++) {
            const y = -0.8 + i * 0.8;
            const leftVertical = new THREE.Mesh(new THREE.BoxGeometry(0.08, 0.08, 1.5), goldTrimMaterial);
            leftVertical.position.set(-2.25, y, 0);
            this.mesh.add(leftVertical);
            const rightVertical = new THREE.Mesh(new THREE.BoxGeometry(0.08, 0.08, 1.5), goldTrimMaterial);
    ...
    buildTurretBanks() {
        ...
        for (let i = 0; i < 3; i++) {
            const y = -0.6 + i * 0.6;
            const turret = new THREE.Mesh(new THREE.CylinderGeometry(0.15, 0.18, 0.4, 8), turretMaterial);
            turret.position.set(-2.2, y, 0);
            turret.rotation.z = Math.PI / 2; // Point outward
            this.mesh.add(turret);
            // Gold muzzle ring
            const muzzle = new THREE.Mesh(new THREE.TorusGeometry(0.12, 0.03, 8, 12), muzzleMaterial);
    ...
    buildCommandSpire() {
        ...
        const base = new THREE.Mesh(new THREE.CylinderGeometry(0.35, 0.4, 0.5, 8), baseMaterial);
        ...
        this.commandSpire = new THREE.Mesh(new THREE.ConeGeometry(0.3, 2.0, 8), spireMaterial);
        ...
        this.spireGlow = new THREE.Mesh(new THREE.SphereGeometry(0.15, 8, 8), glowMaterial);
        ...
        const ring = new THREE.Mesh(new THREE.TorusGeometry(0.4, 0.04, 8, 16), ringMaterial);
    ...
    buildEnergyCore() {
        ...
        this.energyCoreGlow = new THREE.Mesh(new THREE.TorusGeometry(0.7, 0.08, 8, 16), glowRingMaterial);
        ...
        this.energyCore = new THREE.Mesh(new THREE.SphereGeometry(0.4, 12, 12), coreMaterial);
        ...
        const whiteCore = new THREE.Mesh(new THREE.SphereGeometry(0.2, 8, 8), whiteCoreMaterial);
    ...
    buildGlowRing() {
        ...
        this.glowRing = new THREE.Mesh(new THREE.TorusGeometry(1.5, 0.1, 8, 32), glowRingMaterial);
