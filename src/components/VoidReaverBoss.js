...
class HomingMissile {
    ...
    constructor(scene) {
        ...
        this.trail = new THREE.Mesh(new THREE.ConeGeometry(0.15, 0.8, 8), trailMaterial);
        ...
        const body = new THREE.Mesh(new THREE.SphereGeometry(0.2, 8, 8), bodyMaterial);
        this.mesh.add(body);
        ...
        this.core = new THREE.Mesh(new THREE.SphereGeometry(0.1, 6, 6), coreMaterial);
     ...
     */
    spawn(position, initialVelocity) {
...
export class VoidReaverBoss {
    ...
    constructor(scene, id) {
        ...
        Object.defineProperty(this, "tentacleSwayTime", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "phase3Alternator", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: true
        ...
        Object.defineProperty(this, "phase2Alternator", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: true
        ...
        Object.defineProperty(this, "voidCore", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "voidCoreGlow", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "tentacles", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
     ...
     * @param playerPosition - The player's current position
     */
    fireHomingMissiles(bulletPool, playerPosition) {
        ...
        for (let i = 0; i < missileCount; i++) {
            ...
            const initialVelocity = new THREE.Vector3((Math.random() - 0.5) * 2, -3 - Math.random() * 2, 0);
            missile.spawn({ x: pos.x + offsetX, y: pos.y - 1.0 + offsetY, z: pos.z }, initialVelocity);
        }
    }
    /**
     ...
     * @param playerPosition - The player's current position
     */
    fireAimedBurst(bulletPool, playerPosition) {
        const pos = this.mesh.position;
        // Calculate direction to player
     ...
     * @param playerPosition - The player's current position
     */
    updateMissiles(delta, playerPosition) {
        for (const missile of this.missiles) {
            if (missile.active) {
    ...
    updateAnimations(delta) {
        ...
        if (this.voidCore) {
            ...
            const material = this.voidCore.material;
        ...
        if (this.voidCoreGlow) {
            ...
            const material = this.voidCoreGlow.material;
    ...
    buildMainBody() {
        ...
        const body = new THREE.Mesh(new THREE.SphereGeometry(1.5, 16, 16), bodyMaterial);
        ...
        const inner = new THREE.Mesh(new THREE.SphereGeometry(1.2, 12, 12), innerMaterial);
    ...
    buildArmorPlates() {
        ...
        // Top armor plate
        const topPlate = new THREE.Mesh(new THREE.BoxGeometry(2.2, 0.3, 1.2), plateMaterial);
        topPlate.position.set(0, 1.2, 0);
        topPlate.rotation.z = 0.1;
        this.mesh.add(topPlate);
        // Bottom armor plate
        const bottomPlate = new THREE.Mesh(new THREE.BoxGeometry(2.0, 0.3, 1.0), plateMaterial);
        bottomPlate.position.set(0, -1.2, 0);
        bottomPlate.rotation.z = -0.1;
        this.mesh.add(bottomPlate);
        // Left armor plate
        const leftPlate = new THREE.Mesh(new THREE.BoxGeometry(0.3, 1.8, 1.0), plateMaterial);
        leftPlate.position.set(-1.4, 0, 0);
        leftPlate.rotation.z = 0.2;
        this.mesh.add(leftPlate);
        // Right armor plate
        const rightPlate = new THREE.Mesh(new THREE.BoxGeometry(0.3, 1.8, 1.0), plateMaterial);
        rightPlate.position.set(1.4, 0, 0);
        rightPlate.rotation.z = -0.2;
        this.mesh.add(rightPlate);
        // Front armor plate (facing downward)
        const frontPlate = new THREE.Mesh(new THREE.BoxGeometry(1.8, 0.4, 0.8), plateMaterial);
    ...
    buildVoidCore() {
        ...
        const darkCore = new THREE.Mesh(new THREE.SphereGeometry(0.5, 12, 12), darkCoreMaterial);
        ...
        this.voidCore = new THREE.Mesh(new THREE.SphereGeometry(0.4, 12, 12), coreMaterial);
        ...
        this.voidCoreGlow = new THREE.Mesh(new THREE.TorusGeometry(0.7, 0.08, 8, 16), glowMaterial);
    ...
    buildTentacles() {
        ...
        for (const config of tentacleConfigs) {
            ...
            const tentacle = new THREE.Mesh(new THREE.TorusGeometry(config.length, 0.12, 8, 12, Math.PI / 2), tentacleMaterial);
            // Position tentacle at the edge of the body
            tentacle.position.set(Math.cos(config.angle) * config.radius * 0.7, Math.sin(config.angle) * config.radius * 0.7, 0);
            ...
            const tip = new THREE.Mesh(new THREE.SphereGeometry(0.15, 8, 8), tipMaterial);
    ...
    buildGlowingAccents() {
        ...
        const ring1 = new THREE.Mesh(new THREE.TorusGeometry(1.4, 0.06, 8, 24), accentMaterial);
        ring1.rotation.x = Math.PI / 2;
        this.mesh.add(ring1);
        // Vertical ring
        const ring2 = new THREE.Mesh(new THREE.TorusGeometry(1.3, 0.05, 8, 24), accentMaterial);
        ring2.rotation.y = Math.PI / 2;
        this.mesh.add(ring2);
        // Diagonal ring
        const ring3 = new THREE.Mesh(new THREE.TorusGeometry(1.2, 0.04, 8, 24), accentMaterial);
